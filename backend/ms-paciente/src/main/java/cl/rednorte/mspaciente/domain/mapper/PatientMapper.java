package cl.rednorte.mspaciente.domain.mapper;

import cl.rednorte.mspaciente.domain.PatientModel;
import cl.rednorte.mspaciente.domain.IdentifierModel;
...
public class PatientMapper {
    ...
    public static PatientModel toModel(Patient fhir) {
        ...
        if (fhir.hasGender()) {
            try {
                model.setGender(cl.rednorte.mspaciente.domain.types.Gender.valueOf(fhir.getGender().toCode().toUpperCase()));
            } catch (Exception e) {
                model.setGender(cl.rednorte.mspaciente.domain.types.Gender.UNKNOWN);
            }
        }
    ...
    private static IdentifierModel toModelIdentifier(Identifier fhir) {
        ...
        if (fhir.hasType()) {
            try {
                model.setType(cl.rednorte.mspaciente.domain.types.IdentifierType.valueOf(fhir.getType().getText().toUpperCase()));
            } catch (Exception e) {
                // Handle unknown type
            }
        }
