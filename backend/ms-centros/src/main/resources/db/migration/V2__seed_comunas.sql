-- Poblado de las 346 comunas oficiales de Chile, agrupadas por región.
INSERT INTO comunas (id_comuna, nombre, id_region) VALUES
    -- REGIÓN METROPOLITANA (id_region = 1)
    ...
    -- REGIÓN DE COQUIMBO (id_region = 6)
    ...
    -- REGIÓN DE VALPARAÍSO (id_region = 7)
    ...
    -- REGIÓN DE O'HIGGINS (id_region = 8)
    ...
    -- REGIÓN DEL BÍOBÍO (id_region = 11)
    ...
    (249, 'YUMBEL', 11), (250, 'ALTO BIOBÍO', 11),

    -- REGIÓN DE LA ARAUCANÍA (id_region = 12)
    (251, 'TEMUCO', 12), (252, 'PADRE LAS CASAS', 12), (253, 'VILLARRICA', 12), (254, 'ANGOL', 12), (255, 'CARAHUE', 12),
    (256, 'CHOLCHOL', 12), (257, 'COLLIPULLI', 12), (258, 'CURACAUTÍN', 12), (259, 'CURARREHUE', 12), (260, 'ERCILLA', 12),
    (261, 'FREIRE', 12), (262, 'GALVARINO', 12), (263, 'GORBEA', 12), (264, 'LAUTARO', 12), (265, 'LONCOCHE', 12),
    (266, 'LONQUIMAY', 12), (267, 'LOS SAUCES', 12), (268, 'LUMACO', 12), (269, 'MELIPEUCO', 12), (270, 'NUEVA IMPERIAL', 12),
    (271, 'PERQUENCO', 12), (272, 'PITRUFQUÉN', 12), (273, 'PUCÓN', 12), (274, 'PUREN', 12), (275, 'RENAICO', 12),
    (276, 'SAAVEDRA', 12), (277, 'TEODORO SCHMIDT', 12), (278, 'TOLTÉN', 12), (279, 'TRAIGUÉN', 12), (280, 'VICTORIA', 12),
    (281, 'VILCÚN', 12),

    -- REGIÓN DE LOS RÍOS (id_region = 13)
    (282, 'VALDIVIA', 13), (283, 'CORRAL', 13), (284, 'FUTRONO', 13), (285, 'LAGO RANCO', 13), (286, 'LANCO', 13),
    (287, 'LA UNIÓN', 13), (288, 'LOS LAGOS', 13), (289, 'MAFIL', 13), (290, 'MARIQUINA', 13), (291, 'PAILLACO', 13),
    (292, 'PANGUIPULLI', 13), (293, 'RÍO BUENO', 13),

    -- REGIÓN DE LOS LAGOS (id_region = 14)
    (294, 'PUERTO MONTT', 14), (295, 'OSORNO', 14), (296, 'PUERTO VARAS', 14), (297, 'CASTRO', 14), (298, 'ANCUD', 14),
    (299, 'CALBUCO', 14), (300, 'CHAITÉN', 14), (301, 'CHONCHI', 14), (302, 'COCHAMÓ', 14), (303, 'CURACO DE VÉLEZ', 14),
    (304, 'DALCAHUE', 14), (305, 'FRESIA', 14), (306, 'FRUTILLAR', 14), (307, 'FUTALEUFÚ', 14), (308, 'HUALAIHUÉ', 14),
    (309, 'LLANQUIHUE', 14), (310, 'LOS MUERMOS', 14), (311, 'MAULLÍN', 14), (312, 'PALENA', 14), (313, 'PUERTO OCTAY', 14),
    (314, 'PUQUELDÓN', 14), (315, 'PURRANQUE', 14), (316, 'PUYEHUE', 14), (317, 'QUEILÉN', 14), (318, 'QUELLÓN', 14),
    (319, 'QUEMCHI', 14), (320, 'QUINCHAO', 14), (321, 'RÍO NEGRO', 14), (322, 'SAN JUAN DE LA COSTA', 14), (323, 'SAN PABLO', 14),

    -- REGIÓN DE AYSÉN (id_region = 15)
    (324, 'COYHAIQUE', 15), (325, 'AYSÉN', 15), (326, 'CHILE CHICO', 15), (327, 'CISNES', 15), (328, 'COCHRANE', 15),
    (329, 'GUAITECAS', 15), (330, 'LAGO VERDE', 15), (331, 'O''HIGGINS', 15), (332, 'RÍO IBÁÑEZ', 15), (333, 'TORTEL', 15),

    -- REGIÓN DE MAGALLANES Y DE LA ANTÁRTICA CHILENA (id_region = 16)
    (334, 'PUNTA ARENAS', 16), (335, 'CABO DE HORNOS', 16), (336, 'LAGUNA BLANCA', 16), (337, 'NATALES', 16), (338, 'PORVENIR', 16),
    (339, 'PRIMAVERA', 16), (340, 'RÍO VERDE', 16), (341, 'SAN GREGORIO', 16), (342, 'TIMAUKEL', 16), (343, 'TORRES DEL PAINE', 16),
    (344, 'ANTÁRTICA', 16)
